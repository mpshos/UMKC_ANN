function [I,labels,I_test,labels_test] = emnist_readMNIST_cell(num)
...
path = './emnist_train-images-idx3-ubyte';
if(~exist(path,'file'))
...
%============Loading labels
path = './emnist_train-labels-idx1-ubyte';
if(~exist(path,'file'))
...
path = './emnist_t10k-images-idx3-ubyte';
if(~exist(path,'file'))
...
%============Test labels
path = './emnist_t10k-labels-idx1-ubyte';
if(~exist(path,'file'))
