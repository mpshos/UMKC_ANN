function [I,labels,I_test,labels_test] = fashion_readMNIST_cell(num)
...
path = './fashion_train-images-idx3-ubyte';
if(~exist(path,'file'))
...
%============Loading labels
path = './fashion_train-labels-idx1-ubyte';
if(~exist(path,'file'))
...
path = './fashion_t10k-images-idx3-ubyte';
if(~exist(path,'file'))
...
%============Test labels
path = './fashion_t10k-labels-idx1-ubyte';
if(~exist(path,'file'))
