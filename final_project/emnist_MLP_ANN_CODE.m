...
training_samples = 124800; %select the number of sample 
[images, labels]= readMNIST_vector('emnist_train-images-idx3-ubyte','emnist_train-labels-idx1-ubyte',training_samples,0,trim_scale); % initialize figure  
...
source_labels(source_labels==0)=26;                         
